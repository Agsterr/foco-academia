  ...
  return (
    <div className="mx-auto flex min-h-full max-w-lg flex-col justify-center px-4 py-8">
      <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-xl">
        ...
        <p className="mt-1 text-sm text-slate-400">Gerencie alunos e treinos</p>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-violet-600 py-2.5 font-medium hover:bg-violet-500 disabled:opacity-50"
          >
        ...
        <p className="mt-4 text-center text-xs text-slate-500">
          Demo: instrutor@academia.com / instrutor123
        </p>
      </div>
    </div>
  );
